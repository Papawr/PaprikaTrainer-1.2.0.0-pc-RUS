...
translate russia strings:
    ...
    new "Развивает диалог и активирует интерфейс."
    ...
    new "Пропускает диалог при удерживание вниз"
    ...
    new "Переключение пропуска диалогов"
    ...
    new "Откат к более позднему диалогу"
    ...
    new "Переключает вспомогательный {a=https://www.renpy.org/l/voicing}self-voicing{/a}."
    ...
    old "{color=#fff}Yes{/color}"
    new "Да"

    # game/screens.rpy:1356
    old "{color=#fff}No{/color}"
    new "Нет"
