...
translate russia inspLoot_e8a17362:
    ...
    "Ящик полон добычии из предыдущих миссий."
...
translate russia inspInjectorSmall_745b76e1:
    ...
    "Маленький шприц с наноботами. Его можно вводить своим шпионам для получения дополнительных навыков и способностей, но при этом повышается уровень наноботов, что делает шпионов бесконтрольными."

# game/items.rpy:3850
translate russia useInjectorSmall_b4f70c96:

    # y "We don't know what these do yet. Best leave them alone until we found out."
    y "Мы пока не знаем, что они делают. Лучше оставить их в покое, пока мы не выясним."

# game/items.rpy:3858
translate russia useInjectorSmall_8c6e9a49:

    # "Out of nanobot injectors."
    "Закончились инжекторы наноботов."
...
translate russia injectButton_f3aa000e:
    ...
    "{b}Энергичный шпион{/b} - Увеличивает шансы на (захват) на 15%%."
...
translate russia injectButton_452ab4f5:
    ...
    "{b}(Wizkid){/b} - Увеличивает шанс взлома на 25%%."
...
translate russia injectButton_c5e00700:
    ...
    "{b}Второй шанс{/b} - Вместо урона, у шпионов есть шанс заблокировать удар противника."
...
translate russia injectButton_255d423e:
    ...
    "{b}Сок счастья{/b} - Моральный дух шпиона быстрее останавливается ночью."
...
translate russia injectButton_1b84abe8:
    ...
    "{b}Гибкость{/b} - Шпионы приносят больше денег во время стриптиза."
...
translate russia inspRecipeBook_070a6ec9:
    ...
    "Знания возросли! Теперь вы - старейшина по приготовлению молочных коктейлей. Молочные коктейли продаются дороже."
...
translate russia inspRecipeBook_33b76299:
    ...
    "Знания возросли! Молочные коктейли продаются дороже."
...
translate russia inspRecipeBook_0e511767:
    ...
    "Знания возросли! Теперь вы - Лактозное божество! Молочные коктейли продаются дороже."
...
translate russia inspRecipeBook_f09b62bc:
    ...
    y "Ну что ж... Это была пустая трата врем-..."
...
translate russia inspRecipeBook_84be4283:
    ...
    y "КТО ТЫ?! ПОЧЕМУ ЗДЕСЬ ВДРУГ СТАЛО ТАК СВЕТЛО?!"
...
translate russia inspRecipeBook_dd333df9:
    ...
    y "О БОЖЕ, КАЖЕТСЯ, Я НАЧИНАЮ ВИДЕТЬ ПЯТНА!"
...
translate russia inspRecipeBook_989e341d:
    ...
    y "Кто...{w} Кто-нибудь ещё видел что сейчас произошло?"
